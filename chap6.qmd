...
Der Mechanismus ist einfach: Forscher reichen signifikante Ergebnisse nahezu immer zur Publikation ein, weil sie publizierbar sind. Nicht-signifikante Ergebnisse landen dagegen häufiger in der Schublade. Dies geschieht nicht aus Böswilligkeit, sondern weil Fachzeitschriften sie ohnehin seltener annehmen und Forschende daher oft gar nicht erst die Mühe des Einreichens auf sich nehmen (Rosenthal, 1979). Das Ergebnis ist eine wissenschaftliche Literatur, die systematisch zu positiv ist.
...
Die Folge: Gutachter sehen nur die präzisesten Studien mit den stärksten gemessenen Effekten. Der Durchschnitt der publizierten Literatur liegt weit über dem wahren Effekt von 2 Minuten. Das System ist echt wirksam, aber die Literatur überschätzt sein Ausmaß massiv. Niemand hat gelogen.
...
1. **Ausgangslage:** Bei 0 % Einreichungslücke siehst du alle 40 Studien. Der Gutachter-Durchschnitt (farbige Linie) liegt nahe am wahren Effekt von 2 Minuten (gestrichelte Linie). Kein Bias.
2. **Einreichungslücke erhöhen:** Erhöhe den Regler schrittweise. Nicht-signifikante Studien verschwinden aus der Literatur, nicht weil jemand sie versteckt, sondern weil sie nie eingereicht wurden. Beobachte, wie der Gutachter-Durchschnitt nach rechts driftet.
3. **Maximaler Bias:** Nur noch die signifikantesten Studien sind sichtbar. Der Gutachter bescheinigt SmartRail eine weit größere Wirkung als die Realität zeigt. Der wahre Effekt existiert, aber die Literatur überschätzt ihn massiv. Niemand hat gelogen.
...
def server(input, output, session):
    ...
    def bias_panel():
        ...
        if pct == 0:
            interpretation = (f"Vollständiges Bild. Gutachter-Durchschnitt liegt "
