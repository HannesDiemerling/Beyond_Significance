...
def server(input, output, session):
    ...
    def dual_plot():
        ...
        ax1.set_title("p Wert schrumpft mit der Stichprobengröße", fontsize=11)
        ...
        bars = ax2.bar(x_pos, means, color=colors, alpha=0.75, width=0.4)
        ...
        ax2.set_title(
            f"Effekt: {DIFF*60:.0f} Sek = {DIFF:.1f} Min  |  95% KI: ±{ci:.2f} Min",
            fontsize=11
        )
