...
def server(input, output, session):
    ...
    def dual_plot():
        ...
        # Erhöhte Breite (14 statt 12) für mehr Platz zwischen den Plots
        ...
        # Explizite Abstände statt tight_layout für stabile Darstellung
        fig.subplots_adjust(wspace=0.35, bottom=0.15, left=0.08, right=0.95)
        return fig
